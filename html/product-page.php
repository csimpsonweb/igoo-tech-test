<div class="container">
    <section class="product-display-page">
        <div class="product">
                    ...
                    <div class="selected-options">
                        ...
                        <div class="fabric-option">
                            <div class="option-fabric">
                                <p>Fabric: <span>SteelcutTrio (+ £30.00)</span></p>
                            </div>
                        </div>
                        <div class="colour-option">
                            <div class="option-color">
                                <p>Colour: <span>SCT526</span></p>
                            </div>
                        </div>
                        <div class="finish-option">
                            <div class="option-finish">
                                <p>Leg Finish: <span>Matt Lacuered Oak</span></p>
                            </div>
                        </div>
                        <div class="additional-option">
                            <div class="option-extra">
                                <p>Optional Seat Cushion: <span>In Same fabric, Group 4+</span></p>
                            </div>
                        </div>
